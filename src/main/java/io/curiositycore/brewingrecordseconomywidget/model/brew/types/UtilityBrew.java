...
public class UtilityBrew extends AbstractBrew {
    protected UtilityBrew(@JsonProperty("internalName")String internalName,@JsonProperty("name") String name, @JsonProperty("cost") int cost, @JsonProperty("effects") Set<Effect> commandEffects, @JsonProperty("ingredients") Set<Ingredient> ingredients, @JsonProperty("owner") String owner) {
    ...
    public static class UtilityBrewBuilder extends AbstractBrewBuilder<UtilityBrew> {
        ...
        public UtilityBrew build() {
            return new UtilityBrew(this.internalName, this.name,this.cost,this.commandEffects,this.ingredients,null);
        }
