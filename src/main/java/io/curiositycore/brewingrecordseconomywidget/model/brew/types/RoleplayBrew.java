...
public class RoleplayBrew extends AbstractBrew {
    protected RoleplayBrew(@JsonProperty("internalName")String internalName,@JsonProperty("name") String name,@JsonProperty("cost") int cost,@JsonProperty("effects") Set<Effect> commandEffects,@JsonProperty("ingredients") Set<Ingredient> ingredients) {
    ...
    public static class RoleplayBrewBuilder extends AbstractBrewBuilder<RoleplayBrew> {
        ...
        public RoleplayBrew build() {
            return new RoleplayBrew(this.internalName, this.name,this.cost,this.commandEffects,this.ingredients);
        }
